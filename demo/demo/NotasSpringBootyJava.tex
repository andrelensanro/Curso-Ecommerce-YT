...
\title{Aprendiendo Java y Spring Boot \LaTeX}
\author{Andrea Selene Sánchez Robles}
\date{enero, 2023}
...
\begin{abstract}
El objetivo de este articulo/documento es poder ir recopilando y procesando todo lo que voy conociendo de spring boot junto a java.
\end{abstract}
